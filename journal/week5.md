...
During the session with organizer Andrew Brown and guest instructor Kirk Kirkconnell, we mapped out our single-table DynamoDB layout and designed the several patterns we would implement in accessing the data in this table.
...
We will create a separate folder for DynamoDB scripting. backend-flask/bin/ddb/ Scripts added are:
